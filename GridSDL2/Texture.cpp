...
void LTexture::renderTile(int x, int y, SDL_Renderer*& Renderer, SDL_Rect* clip, double angle, SDL_Point* center, SDL_RendererFlip flip)
{
...
void LTexture::renderEntity(int x, int y, SDL_Renderer*& Renderer, SDL_Rect* clip, double angle, SDL_Point* center, SDL_RendererFlip flip)
{
